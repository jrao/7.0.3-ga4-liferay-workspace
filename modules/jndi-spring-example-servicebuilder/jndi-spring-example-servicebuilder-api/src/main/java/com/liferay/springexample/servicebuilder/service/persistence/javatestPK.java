 ...
 */
@ProviderType
public class javatestPK implements Comparable<javatestPK>, Serializable {
	public long id;
	public String foo;
	public long bar;
	...
	public javatestPK(long id, String foo, long bar) {
		this.id = id;
		this.foo = foo;
		this.bar = bar;
	}
	...
	@Override
	public int compareTo(javatestPK pk) {
		if (pk == null) {
			return -1;
		}
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof javatestPK)) {
			return false;
		}

		javatestPK pk = (javatestPK)obj;
